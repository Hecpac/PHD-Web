    ...
    <section id="testimonials" className="section-shell section-shell-tight section-brand-wash-bold" aria-label="Client testimonials">
      <Container swiss className="space-y-10">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <Link
            href="/reviews"
            className="inline-flex min-h-[44px] items-center text-sm font-medium text-accent underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
          >
            View all reviews
          </Link>
        </div>
