        ...
        <div className="flex items-center justify-between py-4 md:py-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <CtaLink
              ...
              className={cn(
                "hidden items-center justify-center rounded-full px-5 py-2.5 font-mono text-[10px] font-medium tracking-[0.1em] transition-all duration-300 md:inline-flex sm:text-[11px]",
                isSolidHeader
