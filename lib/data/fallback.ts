...
export const fallbackProjects: Project[] = [
  {
    ...
    gallery: [
      {
        src: "/hero-dfw.svg",
        alt: "Modern courtyard residence in North Dallas",
        width: 1600,
        height: 1000,
      },
    ],
    ...
    heroImage: {
      src: "/hero-dfw.svg",
      alt: "Modern courtyard residence in Preston Hollow, Dallas",
      width: 1600,
      height: 1000,
    },
  ...
  },
  {
    ...
    gallery: [
      {
        src: "/hero-dfw.svg",
        alt: "Contemporary custom home in Fort Worth",
        width: 1600,
        height: 1000,
      },
    ],
    ...
    heroImage: {
      src: "/hero-dfw.svg",
      alt: "Transitional custom home in Westover Hills, Fort Worth",
      width: 1600,
      height: 1000,
    },
  ...
  },
  {
    ...
    gallery: [
      {
        src: "/hero-dfw.svg",
        alt: "Custom home in Prosper with modern profile",
        width: 1600,
        height: 1000,
      },
    ],
  ...
  },
  {
    ...
    gallery: [
      {
        src: "/hero-dfw.svg",
        alt: "Contemporary estate home in Southlake",
        width: 1600,
        height: 1000,
      },
    ],
    ...
    heroImage: {
      src: "/hero-dfw.svg",
      alt: "Contemporary estate in Estes Park, Southlake",
      width: 1600,
      height: 1000,
    },
  ...
  },
  {
    ...
    gallery: [
      {
        src: "/hero-dfw.svg",
        alt: "Tudor Revival custom home in Highland Park",
        width: 1600,
        height: 1000,
      },
    ],
    ...
    heroImage: {
      src: "/hero-dfw.svg",
      alt: "Tudor Revival home in Highland Park, Dallas",
      width: 1600,
      height: 1000,
    },
