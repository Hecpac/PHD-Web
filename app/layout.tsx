...
export const metadata: Metadata = {
  ...
  description: "Design-first custom home builder serving DFW & North Texas. Design-build delivery with decision-gated planning, open-book budgeting, and 835+ homes delivered.",
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Premium Home Design | Custom Homes — DFW & North Texas",
    description: "Design-led custom homes. 835+ delivered across DFW & North Texas with decision-gated planning.",
    url: getSiteUrl(),
